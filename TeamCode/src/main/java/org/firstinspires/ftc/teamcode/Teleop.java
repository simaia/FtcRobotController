...
public class Teleop extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        servoIntake = hardwareMap.get(Servo.class, "Intake Servo");
        servoDrone = hardwareMap.get(Servo.class, "Servo Avion");
        ...
        while (opModeIsActive()) {
            ...
            if(currentGamepad1.a) { //inchis
                servoIntake.setPosition(-0.1);
            } else if (currentGamepad1.b) { //deschis
                servoIntake.setPosition(0.65);
            }
